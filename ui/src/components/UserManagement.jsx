                        ...
                        {users.map(user => (
                            <tr key={user.uId}>
                                ...
                                <td className="border px-4 py-2">
                                    <a href={`/createUser?id=${user.uId}`} className="text-blue-600 hover:text-blue-800">Edit</a>
                                    <button className="text-red-600 hover:text-red-800 ml-2" onClick={() => deleteUser(user.uId)}>Delete</button>
                                </td>
                            </tr>
                        ))}
                    </tbody>
